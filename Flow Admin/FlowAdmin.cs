...
namespace LinkeD365.FlowAdmin
{
    ...
    [ExportMetadata("Name", "Flow Admin")]
    [ExportMetadata("Description", "Tool to administrate Power Automate Flows")]
    ...
    public class FlowAdminPlugin : PluginBase
    {
