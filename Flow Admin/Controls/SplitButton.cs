...
namespace LinkeD365.FlowAdmin
{
    public class SplitButton : Button
    {
        ...
        protected override void OnMouseDown(MouseEventArgs mevent)
        {
            ...
            // Figure out if the button click was on the
            // button itself or the menu split
            if (Menu != null &&
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            {
                // Draw the arrow glyph on the right side of
                // the button
                ...
                // Draw a dashed separator on the left of
                // the arrow
